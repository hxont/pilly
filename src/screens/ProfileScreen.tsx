...
const ProfileScreen = () => {
  ...
  const renderSurveyCard = useCallback((entry, index) => (
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.header}>
            <Image source={require('../assets/profileImage.png')} style={styles.profileIcon} />
            <Text style={styles.headerText}>나의 문진표 기록</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  dateTitle: {
    fontSize: 16, fontWeight: 'bold', color: '#2F55D4',
    marginBottom: 10,
  },
  row: {
    flexDirection: 'row', alignItems: 'center',
